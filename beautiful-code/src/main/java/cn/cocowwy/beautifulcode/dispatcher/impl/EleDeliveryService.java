package cn.cocowwy.beautifulcode.dispatcher.impl;

import cn.cocowwy.beautifulcode.dispatcher.AbstractDeliveryService;
 ...
 */
@Service
public class EleDeliveryService extends AbstractDeliveryService {
    @Override
